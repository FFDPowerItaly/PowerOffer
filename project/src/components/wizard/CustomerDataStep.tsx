...
import { User, Users, Building, Mail, Phone, FileText, Upload, Brain, FileSpreadsheet, FileImage, Package, BookOpen, CheckCircle } from 'lucide-react';
...
const CustomerDataStep: React.FC<CustomerDataStepProps> = ({ customerData, onDataChange }) => {
  ...
  return (
    <div className="p-8">
      ...
      {/* AI Upload Section */}
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-cyan-200 p-8 mb-8">
        ...
        <div 
          className={`border-2 border-dashed rounded-2xl p-12 text-center transition-all duration-300 ${
            isDragOver 
              ? 'border-cyan-400 bg-cyan-50 scale-105 shadow-2xl' 
              : 'border-gray-300 hover:border-cyan-400 bg-gray-50 hover:shadow-xl'
          }`}
          ...
          <label htmlFor="file-upload-wizard" className="cursor-pointer block">
            <div className="flex flex-col items-center space-y-6">
              <div className={`p-6 rounded-full transition-all duration-300 ${
                isDragOver ? 'bg-cyan-100 scale-110' : 'bg-gradient-to-r from-cyan-100 to-blue-100'
              }`}>
              ...
              <div>
                <span className={`text-2xl font-bold transition-colors ${
                  isDragOver ? 'text-cyan-600' : 'text-gray-800'
                }`}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm text-gray-600">
                <div className="flex items-center space-x-2 bg-white rounded-lg p-3 shadow-sm border border-cyan-200">
                ...
                <div className="flex items-center space-x-2 bg-white rounded-lg p-3 shadow-sm border border-red-200">
